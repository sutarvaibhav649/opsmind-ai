            ...
            <div className={`flex items-center bg-[#05122b] rounded-xl px-4 py-2 border transition-all ${
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="bg-[#11234a] text-white px-5 py-1.5 rounded-lg text-sm font-semibold hover:bg-[#1a3a7a] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                        Send
                    </button>
                </div>
